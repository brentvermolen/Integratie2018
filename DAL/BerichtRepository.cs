...
namespace DAL
{
    public class BerichtRepository
    {
        ...
        public Organisatie CreateOrganisatiePersoon(int persoonId, Organisatie organisatie)
        {
            Persoon persoon = ctx.Personen.Find(persoonId);
            persoon.Organisatie = organisatie;
            UpdatePersoon(persoon);
            return organisatie;
        }

        public Organisatie CreateOrganisatie(Organisatie organisatie)
        {
            ctx.Organisaties.Add(organisatie);
            ctx.SaveChanges();
            return organisatie;
        }
        ...
        public void DeleteOrganisatie(int organId)
        {
            ctx.Organisaties.Remove(ReadOrganisatie(organId));
        }
        ...
        public Organisatie ReadOrganisatie(int organId)
        {
        ...
        {
            return ctx.Personen.Include("Organisatie")
