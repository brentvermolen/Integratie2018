...
namespace MVCIntegratie.Controllers
{
    public partial class HomeController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult Home_Ingelogd()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Home_Ingelogd, "https");
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        static readonly ActionParamsClass_Home_Ingelogd s_params_Home_Ingelogd = new ActionParamsClass_Home_Ingelogd();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_Home_Ingelogd Home_IngelogdParams { get { return s_params_Home_Ingelogd; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_Home_Ingelogd
        {
    ...
    public partial class T4MVC_HomeController : MVCIntegratie.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void Home_IngelogdOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string language);

        [NonAction]
        public override System.Web.Mvc.ActionResult Home_Ingelogd(string language)
        {
            ...
            Home_IngelogdOverride(callInfo, language);
            return callInfo;
        }
